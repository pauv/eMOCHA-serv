	...
	<li id="nav_configs"><a href="<?php echo Url::site('admin/choose_config_type') ?>">configs</a></li>
	<li id="nav_alarms"><a href="<?php echo Url::site('admin/patients') ?>">studies/patients</a></li>
